 ...
 * @author ian
 */
public class TestSkit extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestSkit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
